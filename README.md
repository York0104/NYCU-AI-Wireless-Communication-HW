...
- `gym` may print a deprecation or maintenance warning during execution. This does not prevent the scripts from running.
- The task is difficult and may not always reach the goal consistently with the simplified homework architecture.
- The submission version is mainly for demonstrating correct PPO code completion.

## Suggested Submission Choice

If the instructor only asks to fill in the blanks and run the code, [PPO_MountainCar-v0_submit.py](/c:/Users/house/OneDrive/桌面/NYCU/AI無線通訊/HW/HW2/PPO_MountainCar-v0_submit.py) is the safer submission file.

If the instructor allows an extended version with logging and plots, [PPO_MountainCar-v0.py](/c:/Users/house/OneDrive/桌面/NYCU/AI無線通訊/HW/HW2/PPO_MountainCar-v0.py) is the more informative version.
